...
{
    std::cout << "AppHipControlTFModelTest" << std::endl;
    ...
    // simulation
    HipControlTFModel* const myModel = new HipControlTFModel();
    btVector3 goalTrajectory = btVector3(0,0,0);
    // Fifth, select the controller to use 
    HipControlTFController* const pTC = new HipControlTFController(5, timestep_physics, goalTrajectory);
