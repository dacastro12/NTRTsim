...
/**
 * @file SimHipTFController.cpp
 * @brief Preferred Length Controller for SimHipTFModel
...
SimHipTFController::SimHipTFController(const double initialLength, double timestep) :
    m_initialLengths(initialLength),
    m_totalTime(0.0),
    dt(timestep) {}

//Fetch all the muscles and set their preferred length
void SimHipTFController::onSetup(SimHipTFModel& subject) {
...
void SimHipTFController::onStep(SimHipTFModel& subject, double dt) {
...
void SimHipTFController::setflexionTargetLength(SimHipTFModel& subject, double dt) {
...
void SimHipTFController::moveAllMotors(SimHipTFModel& subject, double dt) {
...
void SimHipTFController::updateActions(SimHipTFModel& subject, double dt) {
...
vector< vector <double> > SimHipTFController::transformActions(vector< vector <double> > actions)
{
	double min=6;
	double max=12;
...
void SimHipTFController::applyActions(SimHipTFModel& subject, vector< vector <double> > act)
{
