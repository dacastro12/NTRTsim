...
#ifndef SimHip_TF_MODEL_H
#define SimHip_TF_MODEL_H

/**
 * @file SimHipTFModel.h
 ...
 */
class SimHipTFModel : public tgSubject<SimHipTFModel>, public tgModel
{
public:
