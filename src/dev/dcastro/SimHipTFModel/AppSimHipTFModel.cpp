...
{
    std::cout << "AppSimHipTFModelTest" << std::endl;
    ...
    // simulation
    SimHipTFModel* const myModel = new SimHipTFModel();
    //for just static model uncomment the below text
      //SimHipTFModel* const myModel = new SimHipTFModel;

    // Fifth, select the controller to use 
    SimHipTFController* const pTC = new SimHipTFController(5, timestep_physics);
